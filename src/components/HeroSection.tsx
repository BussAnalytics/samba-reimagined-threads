...
const HeroSection = () => {
  ...
  return <section id="inicio" className="min-h-screen flex items-end justify-center relative overflow-hidden pb-20">
      ...
      <img src="/lovable-uploads/8491829f-b8a7-406c-acab-dd8f4bd0e5d8.png" alt="S.A.M.B.A. Hero Background" className="absolute inset-0 w-full h-full object-contain md:object-cover md:object-top grayscale" />
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="hidden md:block mb-4">
          ...
          <p className="font-playfair text-2xl lg:text-3xl text-black md:text-white animate-fade-in-up" style={{
            animationDelay: '0.2s'
          }}>
        ...
        <p className="font-poppins text-lg md:text-xl text-black md:text-white mb-8 animate-fade-in-up" style={{
        animationDelay: '0.4s'
      }}>
